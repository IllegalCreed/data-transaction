<template>
  <div class="mine-demand-root-container">
    <span text-2xl font-bold>我发布的需求</span>

    <div class="search-filter">
      <el-input class="search-input" v-model="searchQuery" placeholder="搜索需求" clearable>
        <template #append>
          <el-button>
      ...
      <div flex flex-row items-center>
        <strong>状态：</strong>
        <el-select class="status-select" v-model="selectedStatus" placeholder="选择订需求状态">
          <el-option
